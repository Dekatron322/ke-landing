      ...
      <div className="large-text relative z-10 mx-auto mb-10 mt-10 flex w-full flex-col items-center justify-between gap-8 md:mt-36 md:flex-row md:items-start">
        <div className="w-full md:w-auto">
          ...
          >
            ...
            <div>
              <button className="button-style mx-auto mt-3 flex items-center justify-center gap-2 px-4 py-2 text-sm transition-all duration-300 group-hover:gap-3 max-sm:w-fit max-sm:gap-1 max-sm:px-3 max-sm:py-2 max-sm:text-sm md:mx-0 md:justify-start md:text-base">
